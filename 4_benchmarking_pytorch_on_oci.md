...
## Using the MNIST model

For measuring PyTorch's performance, we'll use the [MNIST model](), previously mentioned [in the last article.]() If you're interested in understanding the data structure, please head over to the previous article before continuing with this one.
